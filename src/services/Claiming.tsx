        ...
        <>
          ...
          {claimingState === 'success' && (
            <a
              ...
              href="https://twitter.com/intent/tweet?text=I+have+just+claimed+my+LZRD+tokens!+Check+your+wallet+on+https://planetsomewhere.xyz/claiming+to+see+if+your+eligible,+too.%23planet_swh+%23PlanetSWH+%23multichainbridge"
              target="_blank"
              rel="noreferrer">
